...
<div class="confirmation-card">
            ...
            <span class="value">
                <c:choose>
                    <c:when test="${not empty tarifDefaut.categoriePersonne}">
                        ${tarifDefaut.categoriePersonne.libelle}
                    </c:when>
                    <c:otherwise>
                        Toutes catégories
                    </c:otherwise>
    ...
    <form method="POST" action="<c:url value='/tarifs-defaut/${tarifDefaut.id}/supprimer'/>" class="confirmation-form">
        <button type="submit" class="btn btn-danger btn-large">
            <i class="fas fa-trash"></i> Supprimer ce tarif
        </button>
        <a href="<c:url value='/tarifs-defaut/${tarifDefaut.id}'/>" class="btn btn-secondary btn-large">
